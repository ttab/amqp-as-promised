...
(function() {
  ...
  module.exports = function(conf) {
    var bind, conn, exchange, isShutdown, local, queue, shutdown, shutdownDef, unbind, _exchange;
      ...
      conn.then((function(_this) {
        return function(mq) {
          ...
          return mq.queue(qname, opts, function(queue) {
            ...
            return def.resolve(new QueueWrapper(_this, queue));
          });
        };
      })(this)).done();
      return def.promise;
    };
    bind = function(exchange, qname, topic, callback) {
      var def;
      if (local) {
      ...
      def = Q.defer();
      (Q.all([_exchange(exchange), queue(qname)])).spread(function(ex, q) {
